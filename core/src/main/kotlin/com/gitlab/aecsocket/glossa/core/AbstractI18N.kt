                                    ...
                                    template.content.forEach { childTemplate ->
                                        makeTokens(locale, childTemplate, when (childState) {
                                            is Argument.ArgMap<T>.State -> childState
                                                ...
                                                is Argument.Raw<T>.State -> Argument.Factory.Raw {
                                                    Argument.Raw(
                                                        childState.backing.value
                                                    )
                                                }
                                                is Argument.Substitution<T>.State -> Argument.Factory.Substitution {
                                                    Argument.Substitution(
                                                        childState.backing.value
                                                    )
                                                }
                                                is Argument.ArgList<T>.State -> Argument.Factory.Scoped {
                                                    Argument.ArgList(
                                                        childState.backing.args
                                                    )
                                                }
